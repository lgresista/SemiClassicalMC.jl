...
function LinearAlgebra.dot(s_i :: Vector{Float64}, M :: DiagInteractionMatrix, s_j)
    return @fastmath @inbounds s_i[1] * M.m11 * s_j[1] + s_i[2] * M.m22 * s_j[2] + s_i[3] * M.m33 * s_j[3] 
end

function LinearAlgebra.dot(Tsq :: Vector{Float64}, M :: DiagInteractionMatrix)
